...
namespace TWE {
    ...
    public:
        ...
        static void deserialize(Scene* scene, const std::string& path, Registry<Behavior>& registry);
    private:
        ...
        static void deserializeEntity(Scene* scene, Entity& entity, nlohmann::json& jsonComponents, Registry<Behavior>& registry);
